...
class LanguageCode {
  ...
  static List<LanguageCode> listFromJson(List<dynamic> json, {bool emptyIsNull, bool growable,}) =>
    json == null || json.isEmpty
      ? true == emptyIsNull ? null : <LanguageCode>[]
      : json
          .map((value) => LanguageCode.fromJson(value))
...
class LanguageCodeTypeTransformer {
  ...
  factory LanguageCodeTypeTransformer() => _instance ??= LanguageCodeTypeTransformer._();
