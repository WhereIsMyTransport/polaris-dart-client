...
class Geocoder {
  ...
  static List<Geocoder> listFromJson(List<dynamic> json, {bool emptyIsNull, bool growable,}) =>
    json == null || json.isEmpty
      ? true == emptyIsNull ? null : <Geocoder>[]
      : json
          .map((value) => Geocoder.fromJson(value))
...
class GeocoderTypeTransformer {
  ...
  factory GeocoderTypeTransformer() => _instance ??= GeocoderTypeTransformer._();
