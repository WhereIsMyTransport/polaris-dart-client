...
class PlaceSearchRequest {
  /// Returns a new [PlaceSearchRequest] instance.
  PlaceSearchRequest({
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is PlaceSearchRequest &&
  ...
  @override
  String toString() => 'PlaceSearchRequest[requestId=$requestId, query=$query, callerLocation=$callerLocation, sessionToken=$sessionToken, language=$language]';
  ...
  /// Returns a new [PlaceSearchRequest] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static PlaceSearchRequest fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<PlaceSearchRequest> listFromJson(dynamic json, {bool emptyIsNull, bool growable,}) =>
    json is List && json.isNotEmpty
      ? json.map(PlaceSearchRequest.fromJson).toList(growable: true == growable)
      : true == emptyIsNull ? null : <PlaceSearchRequest>[];

  static Map<String, PlaceSearchRequest> mapFromJson(dynamic json) {
    final map = <String, PlaceSearchRequest>{};
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) => map[key] = PlaceSearchRequest.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of PlaceSearchRequest-objects as value to a dart map
  static Map<String, List<PlaceSearchRequest>> mapListFromJson(dynamic json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<PlaceSearchRequest>>{};
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) {
          map[key] = PlaceSearchRequest.listFromJson(
            value,
