...
class PlaceDetails {
  ...
  @override
  String toString() => 'PlaceDetails[displayText=$displayText, addressText=$addressText, position=$position, distanceAway=$distanceAway, geocoder=$geocoder, agencyId=$agencyId]';
  ...
  static PlaceDetails fromJson(dynamic value) {
    if (value is Map) {
      ...
      return PlaceDetails(
        ...
        agencyId: mapValueOfType<String>(json, r'agencyId'),
      );
    }
    return null;
  }
